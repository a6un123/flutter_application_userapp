...
class _OrderSummary extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final total = state.items.fold(0.0, (sum, item) => sum + item.totalPrice);
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () => _showCheckoutDialog(context, state, total),
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.indigo,
                foregroundColor: Colors.white,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 14,
                              color: total > 50 ? Colors.green : null,
                              fontWeight: total > 50 ? FontWeight.bold : null,
                            ),
                          ),
                        ],
                      ),
                  ...
                  builder: (innerContext) => SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () {
                        ...
                        final finalTotal = total > 50 ? total : total + 5;
                        ...
                        // Place order
                        innerContext.read<OrderBloc>().add(
                          PlaceOrder(
                            items: state.items,
                        ...
                        // Clear cart
                        innerContext.read<CartBloc>().add(ClearCart());
